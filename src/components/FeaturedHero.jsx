...
function Hero({handleInformationScroll,handleTourPlanningScroll,handleLocationShareScroll,reviewRefScroll}) {
  ...
  return (
    <div className="relative ">
      ...
      <div className="absolute  bg-white  -bottom-9 left-1/2 -translate-x-1/2 flex flex-wrap  gap-2 justify-start  md:justify-between rounded-3xl lg:rounded-full px-3 py-2  w-full md:w-4/5 items-center shadow-lg shadow-black/10">
        {" "}
        <div onClick={handleInformationScroll} className="flex flex-grow cursor-pointer  gap-2 md:gap-3   py-1 md:px-6 md:py-4 lg:px-10 lg:py-5 rounded-full items-center">
          <img src={vector1} alt="" className="object-contain h-6 md:h-8" />
          <p className="text-sm md:text-base lg:text-lg font-semibold">
            Information
          </p>
        </div>
        <div onClick={handleTourPlanningScroll} className="flex flex-grow cursor-pointer   py-1  gap-2 md:gap-3 items-center">
          <img src={vector2} alt="" className="object-contain h-6 md:h-8" />
          <p className="text-sm md:text-base lg:text-lg font-semibold">
            Tour Planning
          </p>
        </div>
        <div onClick={handleLocationShareScroll} className="flex flex-grow cursor-pointer   py-1 gap-2 md:gap-3 items-center">
        ...
        {apiData.total_reviews >0 &&(
          <div onClick={reviewRefScroll} className="flex flex-grow cursor-pointer   py-1 gap-2 md:gap-3 items-center">
