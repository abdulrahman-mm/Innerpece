...
//         itemClass="carousel-item-padding-40-px block sm:hidden mt-5"
//       >
...
//         <div className="max-sm:hidden flex flex-wrap items-center justify-start mt-8 gap-x-5 gap-y-14">
//           {popularEventsData.map((items, index) => (
//             <div
//               onClick={() => handleCardClick(items.id, items.title)}
//               key={index}
...
//   const SkeletonCard = () => (
//     <div className="cursor-pointer w-72 border-gray-200 border-2 rounded-lg shadow-lg shadow-black/20">
...
//         <div className=" hidden md:flex flex-wrap items-center justify-start mt-8 gap-x-5 gap-y-14">
//           <div>
//             {Array(5)
//               .fill(0)
//               .map((_, index) => (
...
function ExplorePopularEvents() {
  ...
  return (
    <div className="ms-5 me-5 mt-8 md:ms-16 md:me-16  md:mt-16">
      ...
      {isLoading ? (
        <div className="max-md:hidden flex flex-wrap items-center justify-start mt-8 gap-x-5 gap-y-14">
          {Array(4)
            .fill(0)
            .map((_, index) => (
              <SkeletonCard key={index} />
