...
function OurValue() {
  return (
    <div className="ms-3 me-3 mt-28 md:ms-6 md:me-6 lg:ms-12 lg:me-12 xl:ms-20 xl:me-20 pb-40">
      ...
      <div className="flex flex-col mt-14 items-center gap-8">
        ...
        <hr className="w-full mt-7 mb-7  md:mt-14 md:mb-14 border-sky-800/20" />

        <div className="flex flex-col md:flex-row flex-wrap items-center gap-8 justify-between">
          
          <div className="flex items-center  gap-5 basis-[20%]">
            <hr className="border-sky-800 w-12" />
            <p className="text-2xl font-semibold text-sky-900">Turpis non lorem</p>
          </div>
        ...
        <div className="flex flex-col md:flex-row flex-wrap items-center gap-8 justify-between">
          ...
          <div className="flex items-center  gap-5 basis-[20%]">
            <hr className="border-sky-800 w-12" />
            <p className="text-2xl font-semibold text-sky-900">Enim sit dignissim</p>
          </div>
